<script>
    import { Form, Select, Choice } from "sveltejs-forms";
    ...
    const schema = yup.object().shape({
        ...
        join: yup.date().default(function () {
        return new Date();
        }),
        status: yup.string().required(),
        purchased: yup.string().required(),
    });
    ...
    function getUserinfo() {
        // Get data
        dataTable = JSON.parse(localStorage.getItem('DB')) ?? [];
    }
    ...
    function addUser() {
        ...
        // Set data
        let newData = JSON.parse(localStorage.getItem('DB')) ?? [];

        // Save
        localStorage.setItem('DB', JSON.stringify([...data, ...newData]));
    ...
    function remove(idx) {
        ...
        // Remove
        let dataRemove = newData.filter((word, index) => index !== idx);

        // Save
        localStorage.setItem('DB', JSON.stringify(dataRemove));
    ...
    <div class="mx-auto lg:ml-80" data-bucket="1">
      <section
        ...
        data-component-id="ba5bc4e1_11_awz"
        ...
        <nav class="relative">
          <div class="flex items-center">
            ...
            <ul class="hidden lg:flex items-center space-x-6 mr-6">
              <li>
                <button 
                  ...
                  href="https://shuffle.dev/preview?project=f84331e4670dff4731880696d21d76dddaaa0e47&amp;page=index.html&amp;screen=top#"
                >
                  <svg
                    class="h-6 w-6"
                    viewBox="0 0 24 24"
            ...
            <div class="hidden lg:block">
              <button class="flex items-center">
                <div class="mr-3">
                  <p class="text-sm" data-config-id="name">Thomas Brown</p>
                ...
                <div class="mr-2">
                  <img
                    ...
                    src="./index_files/photo-1568602471122-7832951cc4c5"
                    alt=""
      ...
      <section
        data-section-id="3"
        data-category="ta-headers"
        data-component-id="52511d2d_07_awz"
        class="py-8 px-6"
      >
        <div class="flex flex-wrap items-center">
          <div class="mb-5 lg:mb-0">
            <h2 class="mb-1 text-2xl font-bold" data-config-id="07_header">
              Statistics
            </h2>
            <div class="flex items-center">
              <a
              ...
              >
                ...
                <span data-config-id="07_breadcrumb1">Start</span>
              </a>
              ...
              >
                ...
                <span data-config-id="07_breadcrumb2">Statistics</span>
              </a>
            </div>
          </div>
          <div class="w-full lg:w-auto lg:ml-auto mb-5 lg:mb-0">
            <div class="flex items-center lg:justify-end">
              <label
                ...
                for=""
                data-config-id="07_form1">From</label
              >
              ...
              <label
                class="mx-3 text-sm text-gray-500"
                for=""
                data-config-id="07_form2">to</label
              >
          ...
          <button
            class="flex items-center py-2 px-4 rounded bg-indigo-500 hover:bg-indigo-600 text-white text-xs font-medium"
          ...
          >
            ...
            <span data-config-id="07_action">Add</span>
          </button>
        </div>
      </section>
      ...
      <section
        data-section-id="5"
        data-category="ta-tables"
        data-component-id="2f328778_03_awz"
        data-custom-component-id="106730"
        class="py-8"
      >
        <div class="px-4 mx-auto">
            ...
            <table class="table-auto w-full">
              <thead>
                <tr class="text-xs text-gray-500 text-left"
                  ><th class="pl-6 pb-3 font-medium">Customer ID</th><th
                    class="pb-3 font-medium">User</th
                  ><th class="pb-3 font-medium">Joined</th><th
                    class="pb-3 font-medium">Status</th
                  ><th class="pb-3 font-medium">Purchased</th><th
                    class="pb-3 font-medium">Action</th
                  ></tr
                >
              </thead>
              <tbody>
                {#each dataTable as cell, index}
                  <tr>
                    <td class="py-5 px-6 font-medium">{cell.id}</td>
                    <td class="flex px-4 py-3">
                      <img
                        class="w-8 h-8 mr-4 object-cover rounded-md"
                        src="./index_files/photo-1559893088-c0787ebfc084"
                        alt=""
                      />
                      <div>
                        <p class="font-medium">{cell.user}</p>
                        <p class="text-gray-500">{cell.email}</p>
                      </div>
                    </td>
                    <td class="font-medium">{cell.join}</td>
                    <td>
                      <span
                        class="inline-block py-1 px-2 text-white bg-green-500 rounded-full"
                        >{cell.status}</span
                      >
                    </td>
                    <td>
                      <span
                        class="inline-block py-1 px-2 text-purple-500 bg-purple-50 rounded-full"
                        >{cell.purchased}</span
                      >
                    </td>
                    <td>
                      <button
                        class="inline-block mr-2 transition hover:bg-blue-600"
                        type="button"
                        on:click={toggleModal}
                      >
                        <svg
                      ...
                      <button class="inline-block mr-2 transiton hover:bg-green-600"  on:click="{toggleModal}">
                        <svg
                          width="18"
                          height="18"
                          viewBox="0 0 18 18"
                      ...
                      <button on:click="{() => remove(index)}"
                        class="inline-block transition hover:bg-red-600"
                        href="https://shuffle.dev/preview?project=f84331e4670dff4731880696d21d76dddaaa0e47&amp;page=index.html&amp;screen=top#"
                      >
                        <svg
                          width="20"
          ...
          <div class="flex flex-wrap -mx-4 items-center justify-between">
            <div class="w-full lg:w-1/3 px-4 flex items-center mb-4 lg:mb-0">
              ...
              <div
                class="mx-3 py-2 px-2 text-xs text-gray-500 bg-white border rounded"
              >
                <select name="" id="">
      ...
      <div class="">
        ...
        <div class="flex flex-col px-6 py-5 bg-white">
          <div class="text-white font-medium ">
            <form {schema} validateOnBlur={false} validateOnChange={false}>
              <div class="mb-6">
                <label
                  for="id"
                ...
                <input
                  type="id"
                  id="id"
                  class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 form-control"
        ...
        <div
          class="flex items-center bg-white justify-end p-6 border-t border-solid border-blueGray-200 rounded-b"
        >
          <button
            class="bg-emerald-500  text-white bg-red-600 background-transparent font-bold uppercase px-6 py-3 text-sm outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
            type="button"
            on:click={toggleModal} 
          >
            Close
          ...
          <button
            class="bg-emerald-500 text-white bg-blue-700 active:bg-emerald-600 font-bold uppercase text-sm px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
            type="button"
            on:click={addUser} on:click="{toggleModal}" 
          >
            Save Changes
          </button>
        </div>
